...
- [ ] T026 [US1] `backend/app/services/indicators.py` 구현 — pandas_ta 기술 지표 계산: calculate_all(df) → SMA(5·20·50·200), RSI(14), MACD(12·26·9), 볼린저밴드(20·2σ), 스토캐스틱(14·3·3); 데이터 200개 미만 시 ValueError; NaN 처리 포함
